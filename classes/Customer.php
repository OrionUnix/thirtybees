...
class CustomerCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields'  => [
            ...
            'last_passwd_gen'            => ['type' => self::TYPE_DATE, 'copy_post' => false, 'dbType' => 'timestamp', 'dbDefault' => self::DEFAULT_CURRENT_TIMESTAMP],
            ...
            'note'                       => ['type' => self::TYPE_HTML, 'validate' => 'isCleanHtml', 'copy_post' => false, 'size' => self::SIZE_TEXT],
        ...
        'keys' => [
            'customer' => [
                'customer_email'     => ['type' => TableKey::KEY, 'columns' => ['email']],
                'customer_login'     => ['type' => TableKey::KEY, 'columns' => ['email', 'passwd']],
                'id_customer_passwd' => ['type' => TableKey::KEY, 'columns' => ['id_customer', 'passwd']],
                'id_gender'          => ['type' => TableKey::KEY, 'columns' => ['id_gender']],
