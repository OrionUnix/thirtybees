    ...
    public static $definition = [
        ...
        'keys' => [
            'supply_order_detail' => [
                ...
                'id_product_product_attribute' => ['type' => TableKey::KEY, 'columns' => ['id_product', 'id_product_attribute']],
                'id_supply_order'              => ['type' => TableKey::KEY, 'columns' => ['id_supply_order', 'id_product']],
            ],
        ],
    ];
