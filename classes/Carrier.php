...
class CarrierCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'keys' => [
            'carrier' => [
                'deleted'            => ['type' => TableKey::KEY, 'columns' => ['deleted', 'active']],
                'id_tax_rules_group' => ['type' => TableKey::KEY, 'columns' => ['id_tax_rules_group']],
                'reference'          => ['type' => TableKey::KEY, 'columns' => ['id_reference', 'deleted', 'active']],
            ],
            'carrier_shop' => [
                'id_shop' => ['type' => TableKey::KEY, 'columns' => ['id_shop']],
            ],
            'carrier_lang' => [
                'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_lang', 'id_shop', 'id_carrier']],
            ],
        ],
    ];
