...
class ProductCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields'         => [
            ...
            'description'               => ['type' => self::TYPE_HTML, 'lang' => true, 'validate' => 'isCleanHtml', 'size' => self::SIZE_TEXT],
            'description_short'         => ['type' => self::TYPE_HTML, 'lang' => true, 'validate' => 'isCleanHtml', 'size' => self::SIZE_TEXT],
        ...
        'keys' => [
            'product' => [
                'date_add'             => ['type' => TableKey::KEY, 'columns' => ['date_add']],
                'id_category_default'  => ['type' => TableKey::KEY, 'columns' => ['id_category_default']],
                'indexed'              => ['type' => TableKey::KEY, 'columns' => ['indexed']],
                'product_manufacturer' => ['type' => TableKey::KEY, 'columns' => ['id_manufacturer', 'id_product']],
                'product_supplier'     => ['type' => TableKey::KEY, 'columns' => ['id_supplier']],
            ],
            'product_lang' => [
                'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_product', 'id_shop', 'id_lang']],
                'id_lang' => ['type' => TableKey::KEY, 'columns' => ['id_lang']],
                'name'    => ['type' => TableKey::KEY, 'columns' => ['name']],
            ],
            'product_shop' => [
                'date_add'            => ['type' => TableKey::KEY, 'columns' => ['date_add', 'active', 'visibility']],
                'id_category_default' => ['type' => TableKey::KEY, 'columns' => ['id_category_default']],
                'indexed'             => ['type' => TableKey::KEY, 'columns' => ['indexed', 'active', 'id_product']],
            ],
        ],
    ];
