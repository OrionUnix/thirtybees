...
class CategoryCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'keys' => [
            'category' => [
                'activenleft'      => ['type' => TableKey::KEY, 'columns' => ['active', 'nleft']],
                'activenright'     => ['type' => TableKey::KEY, 'columns' => ['active', 'nright']],
                'category_parent'  => ['type' => TableKey::KEY, 'columns' => ['id_parent']],
                'level_depth'      => ['type' => TableKey::KEY, 'columns' => ['level_depth']],
                'nleftrightactive' => ['type' => TableKey::KEY, 'columns' => ['nleft', 'nright', 'active']],
                'nright'           => ['type' => TableKey::KEY, 'columns' => ['nright']],
            ],
            'category_lang' => [
                'primary'       => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_category', 'id_shop', 'id_lang']],
                'category_name' => ['type' => TableKey::KEY, 'columns' => ['name']],
            ],
        ],
    ];
