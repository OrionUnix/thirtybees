...
class OrderDetailCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'keys' => [
            'order_detail' => [
                'id_order_id_order_detail' => ['type' => TableKey::KEY, 'columns' => ['id_order', 'id_order_detail']],
                'id_tax_rules_group'       => ['type' => TableKey::KEY, 'columns' => ['id_tax_rules_group']],
                'order_detail_order'       => ['type' => TableKey::KEY, 'columns' => ['id_order']],
                'product_attribute_id'     => ['type' => TableKey::KEY, 'columns' => ['product_attribute_id']],
                'product_id'               => ['type' => TableKey::KEY, 'columns' => ['product_id']],
            ],
        ],
    ];
