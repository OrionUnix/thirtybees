...
class CartCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields'  => [
            ...
            'gift_message'            => ['type' => self::TYPE_STRING, 'validate' => 'isMessage', 'size' => self::SIZE_TEXT],
            'mobile_theme'            => ['type' => self::TYPE_BOOL, 'validate' => 'isBool', 'dbType' => 'tinyint(1)', 'dbDefault' => '0'],
            'delivery_option'         => ['type' => self::TYPE_STRING, 'size' => self::SIZE_TEXT, 'dbNullable' => false],
        ...
        'keys' => [
            'cart' => [
                'cart_customer'       => ['type' => TableKey::KEY, 'columns' => ['id_customer']],
                'id_address_delivery' => ['type' => TableKey::KEY, 'columns' => ['id_address_delivery']],
                'id_address_invoice'  => ['type' => TableKey::KEY, 'columns' => ['id_address_invoice']],
                'id_carrier'          => ['type' => TableKey::KEY, 'columns' => ['id_carrier']],
                'id_currency'         => ['type' => TableKey::KEY, 'columns' => ['id_currency']],
                'id_guest'            => ['type' => TableKey::KEY, 'columns' => ['id_guest']],
                'id_lang'             => ['type' => TableKey::KEY, 'columns' => ['id_lang']],
                'id_shop'             => ['type' => TableKey::KEY, 'columns' => ['id_shop', 'date_add']],
                'id_shop_2'           => ['type' => TableKey::KEY, 'columns' => ['id_shop', 'date_upd']],
                'id_shop_group'       => ['type' => TableKey::KEY, 'columns' => ['id_shop_group']],
            ],
        ],
    ];
