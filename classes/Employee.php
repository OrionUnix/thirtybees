...
class EmployeeCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields'  => [
            ...
            'last_passwd_gen'          => ['type' => self::TYPE_DATE, 'dbType' => 'timestamp', 'dbDefault' => self::DEFAULT_CURRENT_TIMESTAMP],
        ...
        'keys' => [
            'employee' => [
                'employee_login'     => ['type' => TableKey::KEY, 'columns' => ['email', 'passwd']],
                'id_employee_passwd' => ['type' => TableKey::KEY, 'columns' => ['id_employee', 'passwd']],
                'id_profile'         => ['type' => TableKey::KEY, 'columns' => ['id_profile']],
            ],
            'employee_shop' => [
