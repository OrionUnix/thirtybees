...
class CMSCategoryCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields'         => [
            ...
            'description'      => ['type' => self::TYPE_STRING, 'lang' => true, 'validate' => 'isCleanHtml', 'size' => self::SIZE_TEXT],
        ...
        'keys' => [
            ...
            'cms_category_lang' => [
                'primary'       => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_cms_category', 'id_shop', 'id_lang']],
