...
class CoreModelsCore
{
    public static function getModels()
    {
        $access = [
            ...
            'keys' => [
                'access' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_profile', 'id_tab']],
                ],
            ],
        ];
        ...
        $accessory = [
            ...
            'keys' => [
                'accessory' => [
                    'accessory_product' => ['type' => TableKey::KEY, 'columns' => ['id_product_1', 'id_product_2']],
                ],
            ],
        ];
        ...
        $attributeImpact = [
            ...
            'keys' => [
                'attribute_impact' => [
                    'id_product' => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['id_product', 'id_attribute']],
                ],
            ],
        ];
        ...
        $carrierGroup = [
            ...
            'keys' => [
                'carrier_group' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_carrier', 'id_group']],
                ],
            ],
        ];
        ...
        $carrierTaxRulesGroupShop = [
            ...
            'keys' => [
                'carrier_tax_rules_group_shop' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_carrier', 'id_tax_rules_group', 'id_shop']],
                ],
            ],
        ];
        ...
        $carrierZone = [
            ...
            'keys' => [
                'carrier_zone' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_carrier', 'id_zone']],
                ],
            ],
        ];
        ...
        $cartCartRule = [
            ...
            'keys' => [
                'cart_cart_rule' => [
                    'primary'      => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_cart', 'id_cart_rule']],
                    'id_cart_rule' => ['type' => TableKey::KEY, 'columns' => ['id_cart_rule']],
                ],
            ],
        ];
        ...
        $cartProduct = [
            ...
            'keys' => [
                'cart_product' => [
                    'primary'              => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_cart', 'id_product', 'id_product_attribute', 'id_address_delivery']],
                    'id_cart_order'        => ['type' => TableKey::KEY, 'columns' => ['id_cart', 'date_add', 'id_product', 'id_product_attribute']],
                    'id_product_attribute' => ['type' => TableKey::KEY, 'columns' => ['id_product_attribute']],
                ],
            ],
        ];
        ...
        $cartRuleCarrier = [
            ...
            'keys' => [
                'cart_rule_carrier' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_cart_rule', 'id_carrier']],
                ],
            ],
        ];
        ...
        $cartRuleCombination = [
            ...
            'keys' => [
                'cart_rule_combination' => [
                    'primary'        => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_cart_rule_1', 'id_cart_rule_2']],
                    'id_cart_rule_1' => ['type' => TableKey::KEY, 'columns' => ['id_cart_rule_1']],
                    'id_cart_rule_2' => ['type' => TableKey::KEY, 'columns' => ['id_cart_rule_2']],
                ],
            ],
        ];
        ...
        $cartRuleCountry = [
            ...
            'keys' => [
                'cart_rule_country' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_cart_rule', 'id_country']],
                ],
            ],
        ];
        ...
        $cartRuleGroup = [
            ...
            'keys' => [
                'cart_rule_group' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_cart_rule', 'id_group']],
                ],
            ],
        ];
        ...
        $cartRuleProductRuleValue = [
            ...
            'keys' => [
                'cart_rule_product_rule_value' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_product_rule', 'id_item']],
                ],
            ],
        ];
        ...
        $categoryGroup = [
            ...
            'keys' => [
                'category_group' => [
                    'primary'     => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_category', 'id_group']],
                    'id_category' => ['type' => TableKey::KEY, 'columns' => ['id_category']],
                    'id_group'    => ['type' => TableKey::KEY, 'columns' => ['id_group']],
                ],
            ],
        ];
        ...
        $categoryProduct = [
            ...
            'keys' => [
                'category_product' => [
                    'primary'     => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_category', 'id_product']],
                    'id_category' => ['type' => TableKey::KEY, 'columns' => ['id_category', 'position']],
        ...
        $connectionsPage = [
            ...
            'keys' => [
                'connections_page' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_connections', 'id_page', 'time_start']],
                ],
            ],
        ];
        ...
        $customerGroup = [
            ...
            'keys' => [
                'customer_group' => [
                    'primary'        => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_customer', 'id_group']],
                    'customer_login' => ['type' => TableKey::KEY, 'columns' => ['id_group']],
        ...
        $customerMessageSyncImap = [
            ...
            'fields' => [
                'md5_header' => ['type' => ObjectModel::TYPE_STRING, 'required' => true, 'size' => 32, 'dbType' => 'varbinary(32)'],
            ],
            'keys' => [
                'customer_message_sync_imap' => [
                    'md5_header_index' => ['type' => TableKey::KEY, 'columns' => ['md5_header']],
                ],
            ],
        ];
        ...
        $customizedData = [
            ...
            'keys' => [
                'customized_data' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_customization', 'type', 'index']],
                ],
            ],
        ];
        ...
        $featureProduct = [
            ...
            'keys' => [
                'feature_product' => [
                    'primary'          => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_feature', 'id_product']],
                    'id_feature_value' => ['type' => TableKey::KEY, 'columns' => ['id_feature_value']],
                    'id_product'       => ['type' => TableKey::KEY, 'columns' => ['id_product']],
                ],
            ],
        ];
        ...
        $hookModule = [
            ...
            'keys' => [
                'hook_module' => [
                    'primary'   => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_module', 'id_hook', 'id_shop']],
                    'id_hook'   => ['type' => TableKey::KEY, 'columns' => ['id_hook']],
                    'id_module' => ['type' => TableKey::KEY, 'columns' => ['id_module']],
                    'position'  => ['type' => TableKey::KEY, 'columns' => ['id_shop', 'position']],
                ],
            ],
        ];
        ...
        $messageReaded = [
            ...
            'keys' => [
                'message_readed' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_message', 'id_employee']],
                ],
            ],
        ];
        ...
        $module = [
            ...
            'keys' => [
                'module' => [
                    'name' => ['type' => TableKey::KEY, 'columns' => ['name']],
                ],
                'module_shop' => [
        ...
        $moduleAccess = [
            ...
            'keys' => [
                'module_access' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_profile', 'id_module']],
                ],
            ],
        ];
        ...
        $moduleCountry = [
            ...
            'keys' => [
                'module_country' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_module', 'id_shop', 'id_country']],
                ],
            ],
        ];
        ...
        $moduleCurrency = [
            ...
            'keys' => [
                'module_currency' => [
                    'primary'   => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_module', 'id_shop', 'id_currency']],
                    'id_module' => ['type' => TableKey::KEY, 'columns' => ['id_module']],
                ],
            ],
        ];
        ...
        $moduleGroup = [
            ...
            'keys' => [
                'module_group' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_module', 'id_shop', 'id_group']],
                ],
            ],
        ];
        ...
        $modulePreference = [
            ...
            'keys' => [
                'module_preference' => [
                    'employee_module' => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['id_employee', 'module']],
                ],
            ],
        ];
        ...
        $modulesPerfs = [
            ...
            'keys' => [
                'modules_perfs' => [
                    'session' => ['type' => TableKey::KEY, 'columns' => ['session']],
                ],
            ],
        ];
        ...
        $orderDetailTax = [
            ...
            'keys' => [
                'order_detail_tax' => [
                    'id_order_detail' => ['type' => TableKey::KEY, 'columns' => ['id_order_detail']],
                    'id_tax'          => ['type' => TableKey::KEY, 'columns' => ['id_tax']],
                ],
            ],
        ];
        ...
        $orderInvoicePayment = [
            ...
            'keys' => [
                'order_invoice_payment' => [
                    'primary'       => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_order_invoice', 'id_order_payment']],
                    'id_order'      => ['type' => TableKey::KEY, 'columns' => ['id_order']],
                    'order_payment' => ['type' => TableKey::KEY, 'columns' => ['id_order_payment']],
                ],
            ],
        ];
        ...
        $orderReturnDetail = [
            ...
            'keys' => [
                'order_return_detail' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_order_return', 'id_order_detail', 'id_customization']],
                ],
            ],
        ];
        ...
        $orderSlipDetail = [
            ...
            'keys' => [
                'order_slip_detail' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_order_slip', 'id_order_detail']],
                ],
            ],
        ];
        ...
        $orderSlipDetailTax = [
            ...
            'keys' => [
                'order_slip_detail_tax' => [
                    'id_order_slip_detail' => ['type' => TableKey::KEY, 'columns' => ['id_order_slip_detail']],
                    'id_tax'               => ['type' => TableKey::KEY, 'columns' => ['id_tax']],
                ],
            ],
        ];
        ...
        $pack = [
            ...
            'keys' => [
                'pack' => [
                    'primary'      => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_product_pack', 'id_product_item', 'id_product_attribute_item']],
                    'product_item' => ['type' => TableKey::KEY, 'columns' => ['id_product_item', 'id_product_attribute_item']],
                ],
            ],
        ];
        ...
        $pageCache = [
            ...
            'keys' => [
                'page_cache' => [
                    'primary'     => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['cache_hash']],
                    'cache_combo' => ['type' => TableKey::KEY, 'columns' => ['cache_hash', 'id_currency', 'id_language', 'id_country', 'id_shop']],
                ],
            ],
        ];
        ...
        $pageViewed = [
            ...
            'keys' => [
                'page_viewed' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_page', 'id_date_range', 'id_shop']],
                ],
            ],
        ];
        ...
        $productAttachment = [
            ...
            'keys' => [
                'product_attachment' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_product', 'id_attachment']],
                ],
            ],
        ];
        ...
        $productAttributeCombination = [
            ...
            'keys' => [
                'product_attribute_combination' => [
                    'primary'              => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_attribute', 'id_product_attribute']],
                    'id_product_attribute' => ['type' => TableKey::KEY, 'columns' => ['id_product_attribute']],
                ],
            ],
        ];
        ...
        $productAttributeImage = [
            ...
            'keys' => [
                'product_attribute_image' => [
                    'primary'  => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_product_attribute', 'id_image']],
                    'id_image' => ['type' => TableKey::KEY, 'columns' => ['id_image']],
                ],
            ],
        ];
        ...
        $productCarrier = [
            ...
            'keys' => [
                'product_carrier' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_product', 'id_carrier_reference', 'id_shop']],
                ],
            ],
        ];
        ...
        $productCountryTax = [
            ...
            'keys' => [
                'product_country_tax' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_product', 'id_country']],
                ],
            ],
        ];
        ...
        $productGroupReductionCache = [
            ...
            'keys' => [
                'product_group_reduction_cache' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_product', 'id_group']],
                ],
            ],
        ];
        ...
        $productSale = [
            ...
            'keys' => [
                'product_sale' => [
                    'primary'  => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_product']],
                    'quantity' => ['type' => TableKey::KEY, 'columns' => ['quantity']],
                ],
            ],
        ];
        ...
        $productTag = [
            ...
            'keys' => [
                'product_tag' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_product', 'id_tag']],
                    'id_lang' => ['type' => TableKey::KEY, 'columns' => ['id_lang', 'id_tag']],
                    'id_tag'  => ['type' => TableKey::KEY, 'columns' => ['id_tag']],
                ],
            ],
        ];
        ...
        $referrerCache = [
            ...
            'keys' => [
                'referrer_cache' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_connections_source', 'id_referrer']],
                ],
            ],
        ];
        ...
        $requiredField = [
            ...
            'keys' => [
                'required_field' => [
                    'object_name' => ['type' => TableKey::KEY, 'columns' => ['object_name']],
                ],
            ],
        ];
        ...
        $sceneCategory = [
            ...
            'keys' => [
                'scene_category' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_scene', 'id_category']],
                ],
            ],
        ];
        ...
        $sceneProducts = [
            ...
            'keys' => [
                'scene_products' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_scene', 'id_product', 'x_axis', 'y_axis']],
                ],
            ],
        ];
        ...
        $searchIndex = [
            ...
            'keys' => [
                'search_index' => [
                    'primary'    => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_word', 'id_product']],
                    'id_product' => ['type' => TableKey::KEY, 'columns' => ['id_product']],
                ],
            ],
        ];
        ...
        $searchWord = [
            ...
            'keys' => [
                'search_word' => [
                    'id_lang' => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['id_lang', 'id_shop', 'word']],
                ],
            ],
        ];
        ...
        $smartyCache = [
            ...
            'keys' => [
                'smarty_cache' => [
                    'primary'  => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_smarty_cache']],
                    'cache_id' => ['type' => TableKey::KEY, 'columns' => ['cache_id']],
                    'modified' => ['type' => TableKey::KEY, 'columns' => ['modified']],
                    'name'     => ['type' => TableKey::KEY, 'columns' => ['name']],
                ],
            ],
        ];
        ...
        $smartyLastFlush = [
            ...
            'keys' => [
                'smarty_last_flush' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['type']],
                ],
            ],
        ];
        ...
        $smartyLazyCache = [
            ...
            'keys' => [
                'smarty_lazy_cache' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['template_hash', 'cache_id', 'compile_id']],
                ],
            ],
        ];
        ...
        $specificPricePriority = [
            ...
            'keys' => [
                'specific_price_priority' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_specific_price_priority', 'id_product']],
                ]
            ]
        ];
        ...
        $specificPriceRuleCondition = [
            ...
            'keys' => [
                'specific_price_rule_condition' => [
                    'id_specific_price_rule_condition_group' => ['type' => TableKey::KEY, 'columns' => ['id_specific_price_rule_condition_group']],
                ],
            ],
        ];
        ...
        $specificPriceRuleConditionGroup = [
            ...
            'keys' => [
                'specific_price_rule_condition_group' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_specific_price_rule_condition_group', 'id_specific_price_rule']],
                ],
            ],
        ];
        ...
        $tabModulePreference = [
            ...
            'keys' => [
                'tab_module_preference' => [
                    'employee_module' => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['id_employee', 'id_tab', 'module']],
                ],
            ],
        ];
        ...
        $tagCount = [
            ...
            'keys' => [
                'tag_count' => [
                    'primary'  => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_group', 'id_tag']],
                    'id_group' => ['type' => TableKey::KEY, 'columns' => ['id_group', 'id_lang', 'id_shop', 'counter']],
                ],
            ],
        ];
        ...
        $themeMeta = [
            ...
            'keys' => [
                'theme_meta' => [
                    'id_theme_2' => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['id_theme', 'id_meta']],
                    'id_meta'    => ['type' => TableKey::KEY, 'columns' => ['id_meta']],
                    'id_theme'   => ['type' => TableKey::KEY, 'columns' => ['id_theme']],
                ],
            ],
        ];
        ...
        $themeSpecific = [
            ...
            'keys' => [
                'theme_specific' => [
                    'primary' => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_theme', 'id_shop', 'entity', 'id_object']],
                ],
            ],
        ];
        ...
        $warehouseCarrier = [
            ...
            'keys' => [
                'warehouse_carrier' => [
                    'primary'      => ['type' => TableKey::PRIMARY_KEY, 'columns' => ['id_warehouse', 'id_carrier']],
                    'id_carrier'   => ['type' => TableKey::KEY, 'columns' => ['id_carrier']],
        ...
        $webservicePermission = [
            ...
            'keys' => [
                'webservice_permission' => [
                    'resource_2'            => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['resource', 'method', 'id_webservice_account']],
                    'id_webservice_account' => ['type' => TableKey::KEY, 'columns' => ['id_webservice_account']],
                    'method'                => ['type' => TableKey::KEY, 'columns' => ['method']],
                    'resource'              => ['type' => TableKey::KEY, 'columns' => ['resource']],
                ],
            ],
        ];
