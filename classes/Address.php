...
class AddressCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'keys' => [
            'address' => [
                'address_customer' => ['type' => TableKey::KEY, 'columns' => ['id_customer']],
                'id_country'       => ['type' => TableKey::KEY, 'columns' => ['id_country']],
                'id_manufacturer'  => ['type' => TableKey::KEY, 'columns' => ['id_manufacturer']],
                'id_state'         => ['type' => TableKey::KEY, 'columns' => ['id_state']],
                'id_supplier'      => ['type' => TableKey::KEY, 'columns' => ['id_supplier']],
