...
class ImageCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'keys' => [
            'image' => [
                'idx_product_image' => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['id_image', 'id_product', 'cover']],
                'id_product_cover'  => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['id_product', 'cover']],
                'image_product'     => ['type' => TableKey::KEY, 'columns' => ['id_product']],
            ],
            'image_lang' => [
                'id_image' => ['type' => TableKey::KEY, 'columns' => ['id_image']],
            ],
            'image_shop' => [
                'id_product' => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['id_product', 'id_shop', 'cover']],
