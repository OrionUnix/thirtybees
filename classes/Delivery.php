...
class DeliveryCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'keys' => [
            'delivery' => [
                'id_carrier'      => ['type' => TableKey::KEY, 'columns' => ['id_carrier', 'id_zone']],
                'id_range_price'  => ['type' => TableKey::KEY, 'columns' => ['id_range_price']],
                'id_range_weight' => ['type' => TableKey::KEY, 'columns' => ['id_range_weight']],
                'id_zone'         => ['type' => TableKey::KEY, 'columns' => ['id_zone']],
            ],
        ],
    ];
