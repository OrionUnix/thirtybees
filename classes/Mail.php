...
class MailCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields'  => [
            ...
            'date_add'  => ['type' => self::TYPE_DATE, 'validate' => 'isDate', 'copy_post' => false, 'required' => true, 'dbType' => 'timestamp', 'dbDefault' => self::DEFAULT_CURRENT_TIMESTAMP],
        ],
        'keys' => [
            'mail' => [
                'recipient' => ['type' => TableKey::KEY, 'columns' => ['recipient']],
            ],
        ],
    ];
