...
class SpecificPriceCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'keys' => [
            'specific_price' => [
                'id_product_2'           => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['id_product', 'id_product_attribute', 'id_customer', 'id_cart', 'from', 'to', 'id_shop', 'id_shop_group', 'id_currency', 'id_country', 'id_group', 'from_quantity', 'id_specific_price_rule']],
                'from'                   => ['type' => TableKey::KEY, 'columns' => ['from']],
                'from_quantity'          => ['type' => TableKey::KEY, 'columns' => ['from_quantity']],
                'id_cart'                => ['type' => TableKey::KEY, 'columns' => ['id_cart']],
                'id_customer'            => ['type' => TableKey::KEY, 'columns' => ['id_customer']],
                'id_product'             => ['type' => TableKey::KEY, 'columns' => ['id_product', 'id_shop', 'id_currency', 'id_country', 'id_group', 'id_customer', 'from_quantity', 'from', 'to']],
                'id_product_attribute'   => ['type' => TableKey::KEY, 'columns' => ['id_product_attribute']],
                'id_shop'                => ['type' => TableKey::KEY, 'columns' => ['id_shop']],
                'id_specific_price_rule' => ['type' => TableKey::KEY, 'columns' => ['id_specific_price_rule']],
                'to'                     => ['type' => TableKey::KEY, 'columns' => ['to']],
            ],
        ],
    ];
