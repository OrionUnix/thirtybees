...
class ShopUrlCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'keys' => [
            'shop_url' => [
                'full_shop_url'     => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['domain', 'physical_uri', 'virtual_uri']],
                'full_shop_url_ssl' => ['type' => TableKey::UNIQUE_KEY, 'columns' => ['domain_ssl', 'physical_uri', 'virtual_uri']],
                'id_shop'           => ['type' => TableKey::KEY, 'columns' => ['id_shop', 'main']],
            ],
        ],
    ];
